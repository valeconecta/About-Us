    ...
    <div>
      ...
      <section className="relative bg-brand-dark py-32 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://drive.google.com/thumbnail?id=1zkGVXw-qWQhYRT0KRdaOw-yziizogwVd&sz=w1600" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <img src="https://drive.google.com/thumbnail?id=14VJyqHfZ2O9lvaEZT8JeyOQAyVbW7XfN&sz=w1000" className="rounded-2xl shadow-lg mt-8" alt="Pool work" referrerPolicy="no-referrer" />
